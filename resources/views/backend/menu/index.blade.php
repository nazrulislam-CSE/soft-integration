                                ...
                                <form action="{{ route('menu.store') }}" method="post">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="name_en">Menu Name:</label>
                                            @error('name_en')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                            <input type="text" name="name_en" class="form-control" id="name_en" placeholder="Write menu name">
                                        </div>
                                        <div class="mb-4">
                                                ...
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        ...
                                                        @error('name_en')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                        <input type="text" name="name_en" class="form-control" id="name_en" placeholder="Write menu name" value="{{ $menu->name_en }}">
                                                    </div>
                                                    <div class="mb-4">
                                                        <div class="icheck-success d-inline">
