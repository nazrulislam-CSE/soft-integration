    ...
    <div class="row">
       <div class="col-xxl-12">
          <div class="breadcrumb__content p-relative z-index-1">
             <h3 class="breadcrumb__title">Single Project</h3>
        ...
        <div class="row">
           <div class="col-12">
              <div class="sd-big-img">
                <img src="{{ asset($projects->project_image )}}" width="1116" height="673" alt="">
              </div>
           </div>
           <div class="col-xl-6 col-lg-6">
              <div class="sd-service-details">
                <h3 class="tp-title-sm service-details-space"> {{ $projects->project_name_en ?? 'NULL' }}</h3>
              </div>
           </div>
           <div class="col-xl-6 col-lg-6">
              <div class="sd-service-details-paragraph">
                <p class="pb-15">{!! $projects->project_description_en ?? 'NULL' !!}<p>
              </div>
           </div>
        </div>
    </div>
